...
<html lang="it">
  <head>
    ...
    <!-- TITOLO DELLA PAGINA -->
    <title> Tabella Pagamenti - Comitato Sicurezza Stradale </title>
...
<div class="alert alert-info" role="alert">
  <center><b> Benvenuto nella sezione dedicata ai pagamenti dei volontari. </b>
</div>

<form method="GET" action="" class="mb-3">
    <div class="input-group mb-2">
	<a href="aggiungipagamento.php" class="btn btn-outline-primary rounded mr-2">Aggiungi Pagamento</a>
        ...
        <input type="text" name="dataeoradipagamento" class="form-control rounded mr-3" placeholder="Cerca per Data e Ora">
...
if (isset($_GET['submit'])) {
    ...
    $nome = $_GET['nome'];
	$dataeoradipagamento = $_GET['dataeoradipagamento'];

    // Effettua la query per selezionare i volontari corrispondenti alla ricerca
    $sql = "SELECT * FROM quotepagate WHERE cognome LIKE '%$cognome%' AND nome LIKE '%$nome%' AND dataeoradipagamento LIKE '%$dataeoradipagamento%'";
} else {
    // Se non è stata inviata la ricerca, seleziona tutti i volontari
    $sql = "SELECT * FROM quotepagate";
}
...
echo "<table id='tabella'>
				...
				<th><center>Nome</th>
				<th><center>Importo</th>
				<th><center>Registrato Da:</th>
				<th><center>Data e ora di Pagamento</th>
				<th><center>Pagamento Effettuato con:</center></th>
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>";
                            ...
                            echo "<td class='cell100 column2 align-middle text-center '>" . $row["anno"] . "</td>";
							...
							echo "<td class='cell100 column2 align-middle text-center '>" . $row["descrizione"] . "</td>";
              
              echo "<td class='cell100 column2 align-middle text-center'>";
							echo "<a href='guardapagamento.php?id=" . $row["ID"]. "'>";
							echo "<i class='fa fa-eye'></i></a>";

							echo "<td class='cell100 column2 align-middle text-center'>";
							echo "<a href='modificapagamento.php?id=" . $row["ID"]. "'>";
							echo "<i class='fas fa-pencil-alt'></i></a>";  

							echo "<td class='cell100 column2 align-middle text-center'>";
							echo "<a href='eliminapagamento.php?id=" . $row["ID"]. "'>";
...
echo "</td>";
        ...
        echo "<p>Nessun volontario trovato.</p>";
    }
