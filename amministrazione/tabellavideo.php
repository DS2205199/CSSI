...
<html lang="it">
  <head>
    ...
    <!-- TITOLO DELLA PAGINA -->
    <title>Tabella Video - Comitato Sicurezza Stradale </title>
...
<div class="alert alert-info" role="alert">
  <center><b> Benvenuto nella pagina dedicata alla Gestione dei Video </b>
</div>

<form method="GET" action="" class="mb-3">
    <div class="input-group mb-2">
<a href="inseriscivideo.php" class="btn btn-outline-primary rounded mr-2">Aggiungi Video</a>

<input type="text" name="video_title" class="form-control rounded mr-3" placeholder="Nome Video">
        <input type="text" name="last_name" class="form-control rounded mr-3" placeholder="Cognome">
        <input type="text" name="first_name" class="form-control rounded mr-3" placeholder="Nome">
...
if (isset($_GET['submit'])) {
    ...
    $sql = "SELECT * FROM videos WHERE video_title LIKE '%$video_title%' AND last_name LIKE '%$last_name%' AND first_name LIKE '%$first_name%'";
} else {
...
if ($result->num_rows > 0) {
         ...
         echo "<table id='tabella'>
				...
				<th><center>Titolo del Video</th>
				<th><center>Cognome</th>
				<th><center>Nome</th>
				<th><center>Data di Pubblicazione</th>
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>";
                            ...
                            echo "<td class='cell100 column2 align-middle text-center '>" . $row["video_title"] . "</td>";
                            echo "<td class='cell100 column2 align-middle text-center '>" . $row["last_name"] . "</td>";
                            echo "<td class='cell100 column2 align-middle text-center '>" . $row["first_name"] . "</td>";
                            echo "<td class='cell100 column2 align-middle text-center '>" . $row["publish_date"] . "</td>";
                           
							echo "<td class='cell100 column2 align-middle text-center'>";
                            echo "<a href='guardavideo.php?id=" . $row['id'] . "'>";
                            echo "<i class='fa fa-eye'></i></a>";
							
							echo "<td class='cell100 column2 align-middle text-center'>";
                            echo "<a href='modificavideo.php?id=" . $row['id'] . "'>";
                            echo "<i class='fas fa-pencil-alt'></i></a>";                          
                            
                            echo "<td class='cell100 column2 align-middle text-center'>";
                            echo "<a href='eliminavideo.php?id=" . $row['id'] . "'>";
