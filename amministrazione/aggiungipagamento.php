...
<div class="message">
  ...
  <center> <p> Mi dispiace, ma non sei autorizzato a inserire Pagamenti in questa pagina. Se hai bisogno di assistenza o se per te e un errore, contatta amministratore del sistema.</p></center>
  <br>
...
<html lang="en">
  <head>
    ...
    <title>Aggiungi Pagamento - Comitato Sicurezza Stradale </title>
    <!------------------------------------------------------------------------>
...
<!-- HTML FINE MENU NEWS -->
  ...
  <!------------------------------------------------------------------------>
  <!-- INZIO PHP INSERIMENTO SU TABELLA QUOTE PAGATE -->
...
$stmt->execute(array($email, $cognome, $nome, $pageName, $indirizzo_ip, $accesso_negato));
  ...
  $sql = "INSERT INTO quotepagate (numero, cognome, nome, anno, importo, registratoda, dataeoradipagamento, descrizione, email, descrizioneaggiuntive)
  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
   ...
   $stmt->bind_param("ssssssssss", $numero, $cognome, $nome, $anno, $importo, $registratoda, $dataeoradipagamento, $descrizione, $email, $descrizioneaggiuntive);
...
$stmt->close();
            ...
            echo 'Non hai i privilegi necessari per aggiungere Pagamenti. Si prega di contattare amministratore per ulteriori informazioni.';
            echo '</div>';
			echo '<script>
                setTimeout(function() {
...
?>
  ...
  <!-- FINE PHP INSERIMENTO SU TABELLA NEWS DELLE INFORMAZIONI -->
  <!------------------------------------------------------------------------>
  <!-- MENU A TENDINA CON I DATI DELLE TABELLE -->
  ...
  <!-- MENU A TENDINA CON I DATI DELLE TABELLE FINE -->
  <!------------------------------------------------------------------------>
  <!-- INZIO FORM CAMPI -->
  ...
  <div class="card-header"><center>Inserisci Pagamento</center></div>
  <div class="card-body">
  ...
  <div class="col-lg-3">
  <div class="mb-3">
  <label class="form-label"> Importo <i class="fa fa-asterisk"></i> </label>
  <input type="text" name="importo" placeholder="Importo" class="form-control dark-input" required pattern="[0-9]+">
  </div> </div>
  ...
  <div class="mb-3">
  <label class="form-label"> Descrizione <i class="fa fa-asterisk"></i> </label>
  <select class="form-control dark-input" name="descrizione" required"> <?php echo $optionsDescrizioni; ?> </select>
  </div> </div>

  <div class="mb-3">
  <label class="form-label"> Descrizione Aggiuntiva</label>
  <textarea name="descrizioneaggiuntive" placeholder="Descrizione Aggiuntiva" class="form-control dark-input"></textarea>
  </div> </div>

  <div class="card-footer text-end">
  <button type="submit" class="btn btn-primary"> <i class="fa fa-paper-plane" aria-hidden="true"></i> Invia Pagamento</button>
  ...
  <input type="text" name="numero" placeholder="Numero" class="form-control dark-input" required">
  </div> </div>

  <div class="card mb-4 dark-profile">
  <div class="card-body">
  <label class="form-label"> Data e Ora di Pagamento <i class="fa fa-asterisk"></i> </label>
  <input type="text" id="dataeoradipagamento" name="dataeoradipagamento" placeholder="Data e Ora di Pagamento" class="form-control dark-input" required readonly>
	</div> </div> </div>
  ...
  var dataOraInput = document.getElementById('dataeoradipagamento');
