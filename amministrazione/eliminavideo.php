...
<div class="message">
  ...
  <center> <p> Mi dispiace, ma non sei autorizzato a eliminare i Video. Se hai bisogno di assistenza o se per te e un errore, contatta amministratore del sistema.</p></center>
  <br>
...
<html lang="en">
  <head>
    ...
    <title>Elimina Video - Comitato Sicurezza Stradale </title>
    <!------------------------------------------------------------------------>
...
if (isset($_GET['id'])) {
    ...
    if ($stmt->execute()) {
      ...
      echo 'Video eliminato con successo';
    echo '</div>';
    echo '<script>
   setTimeout(function() {
...
echo '<div id="error-message" class="alert alert-danger" role="alert">';
            echo 'Non hai i privilegi necessari per eliminare il video. Si prega di contattare amministratore per ulteriori informazioni.';
            echo '</div>';
			echo '<script>
                setTimeout(function() {
