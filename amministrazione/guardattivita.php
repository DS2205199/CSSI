...
<div class="message">
  ...
  <center> <p> Mi dispiace, ma non sei autorizzato a visualizzare le attivita. Se hai bisogno di assistenza o se per te e un errore, contatta amministratore del sistema.</p></center>
  <br>
...
<html lang="it">
  <head>
    ...
    <!-- TITOLO DELLA PAGINA -->
    <title> Guarda Attività - Comitato Sicurezza Stradale </title>
...
$query = "SELECT * FROM attivita WHERE ID = ?";
$stmt = $conn->prepare($query);
    ...
    if ($result) {
	  ...
	  echo '<div class="alert alert-danger" role="alert">';
      echo "Siamo spiacenti, ma non è stato possibile trovare nessuna attività corrispondente all'ID specificato. Si prega di verificare l'ID inserito e riprovare. Per ulteriori assistenza, siamo a disposizione.";
      echo '</div>';
  }
} else {
	  echo '<div class="alert alert-danger" role="alert">';
            ...
            <div class="card mb-4 dark-profile">
              <div class="card-body">
                <table class="table user-view-table m-0">
                  ...
                  <center>Attività N. <b><?php echo " " . $row["ID"], "" . "<br>";;?></span></h4></center></b> <br>
                  <center>Nome Attività: <b><?php echo " " . $row["nomeattivita"],  " " . "<br>";;?></span></h4></center></b>
                      <br>
					 
	</div>
	<div class="col-md-10">
			<p><b>Posizione Servizio:</b> <span class="text-light"><?php echo $row["posizioneservizio"]; ?></span><p>
			<br>
			<b>Nome Referenti Servizio:</b> <span class="text-light"><?php echo $row["nomereferente"]; ?></span><p>
			<br>
            <b>Area di Intervento:</b> <span class="text-light"><?php echo $row["areadintervento"]; ?></span><p>
			<br>
            <b>Organizzatore:</b> <span class="text-light"><?php echo $row["organizzatore"]; ?></span><p>
			<br>
            <b>Aperto a:</b> <span class="text-light"><?php echo $row["apertoa"]; ?></span><p>
			<br>
            <b>Informazioni Attività:</b> <span class="text-light"><?php echo $row["informazioniattivita"]; ?></span><p>
			<br>
            <b>Data e Ora del Servizio:</b> <span class="text-light"><?php echo $row["dataeoradelservizio"]; ?></span><p>
			<br>
            <b>Minimo Partecipanti:</b> <span class="text-light"><?php echo $row["minpartecipanti"]; ?></span><p>
           <br>
            <b>Massimo Partecipanti:</b> <span class="text-light"><?php echo $row["maxpartecipanti"]; ?></span><p>
		 <hr>
	   </div>
	   </div>
 <!------------------------------------------------------------------------>
