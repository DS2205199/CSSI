...
<div class="message">
  ...
  <center> <p> Mi dispiace, ma non sei autorizzato a visualizzare le riserve. Se hai bisogno di assistenza o se per te e un errore, contatta amministratore del sistema.</p></center>
  <br>
...
<html lang="it">
  <head>
    ...
    <!-- TITOLO DELLA PAGINA -->
    <title> Guarda Riserva - Comitato Sicurezza Stradale </title>
...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM riserve WHERE ID = ?";
    ...
    if ($result) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<div class="alert alert-danger" role="alert">';
            echo "Siamo spiacenti, ma non è stato possibile trovare nessuna riserva corrispondente all'ID specificato. Si prega di verificare l'ID inserito e riprovare. Per ulteriori assistenza, siamo a disposizione.";
            echo '</div>';
        }
    } else {
        echo '<div class="alert alert-danger" role="alert">';
            ...
            <div class="card mb-4 dark-profile">
              <div class="card-body">
                <table class="table user-view-table m-0">
                  ...
                  <center>Riserva N. <b><?php echo " " . $row["ID"], "" . "<br>";;?></span></h4></center></b> <br>
                  <center>Riserva di: <b><?php echo " " . $row["nome"],  " "  . $row["cognome"] . "<br>";;?></span></h4></center></b>
<br>
					 					  
<div class="row">
    <div class="col-md-2">
        <p><b>Stato Riserva:</b> <span class="text-light"><?php echo ($row["attivo"] == "1") ? "Attivo" : (($row["attivo"] == "0") ? "Non Attivo" : $row["attivo"]); ?></span></p>
    <hr>
	</div>
	<div class="col-md-10">
	   <p><b>Cognome:</b> <span class="text-light"><?php echo $row["cognome"]; ?></span> | 
	   <b>Nome:</b> <span class="text-light"><?php echo $row["nome"]; ?></span> | 
	   <b>Inizio:</b> <span class="text-light"><?php echo $row["inizio"]; ?></span> | 
	   <b>Fine:</b> <span class="text-light"><?php echo $row["fine"]; ?></span>
	   <hr>
	       </div>
</div>
 <!------------------------------------------------------------------------>
