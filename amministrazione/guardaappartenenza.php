...
<div class="message">
  ...
  <center> <p> Mi dispiace, ma non sei autorizzato a visualizzare le appartenenze. Se hai bisogno di assistenza o se per te e un errore, contatta amministratore del sistema.</p></center>
  <br>
...
<html lang="it">
  <head>
    ...
    <!-- TITOLO DELLA PAGINA -->
    <title> Guarda Appartenenza - Comitato Sicurezza Stradale </title>
...
<!-- HTML FINE MENU NEWS -->
  ...
  <!------------------------------------------------------------------------>
  <!-- SELEZIONA ID E LI VISUALIZZA NEL FORM -->
...
if (isset($_GET['id'])) {
    ...
    // Esegui la query utilizzando un'istruzione preparata
...
if ($result) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<div class="alert alert-danger" role="alert">';
            echo "Siamo spiacenti, ma non è stato possibile trovare nessuna appartenenza corrispondente all'ID specificato. Si prega di verificare l'ID inserito e riprovare. Per ulteriori assistenza, siamo a disposizione.";
            echo '</div>';
        }
    } else {
        echo '<div class="alert alert-danger" role="alert">';
        echo "Ci scusiamo per l'inconveniente, ma si è verificato un errore nella query. Si consiglia di controllare la sintassi e i parametri della query e riprovare. Se l'errore persiste, ti suggeriamo di contattare il supporto tecnico per ulteriore assistenza nella risoluzione del problema. " . $conn->error;
        echo '</div>';
    }
...
$conn->close();
?>
  <!-- FINE SELEZIONA ID E LI VISUALIZZA NEL FORM -->
  <!------------------------------------------------------------------------>
  <!-- VISUALIZZA NEL FORM -->
            ...
            <div class="card mb-4 dark-profile">
              <div class="card-body">
                <table class="table user-view-table m-0">
                  ...
                  <center>Appartenenza N. <b><?php echo " " . $row["ID"], "" . "<br>";;?></span></h4></center></b> <br>  
				  <center>Appartanenza di: <b><?php echo " " . $row["nome"],  " "  . $row["cognome"] . "<br>";;?></span></h4></center></b>
					<br>
					<br>
...
<div class="row">
    <div class="col-md-2">
        <p><b>Stato Appartenenza:</b> 
		<span class="text-light"><?php echo ($row["attivo"] == "1") ? "Attivo" : (($row["attivo"] == "0") ? "Non Attivo" : $row["attivo"]); ?></span></p>
    <hr>
	</div>
    <div class="col-md-10">
	   <p><b>Cognome:</b> <span class="text-light"><?php echo $row["cognome"]; ?></span> | 
	   <b>Nome:</b> <span class="text-light"><?php echo $row["nome"]; ?></span> | 
	   <b>Inizio Appartenenza:</b> <span class="text-light"><?php echo $row["inizio"]; ?></span> | 
	   <b>Fine Appartenenza:</b> <span class="text-light"><?php echo $row["fine"]; ?></span> | 
	   <b>Tipo Appartenenza:</b> <span class="text-light"><?php echo $row["tipo"]; ?></span> |
	   <b>Sede:</b> <span class="text-light"><?php echo $row["sede"]; ?></span></p>
	   <hr>
    </div>
</div>
