...
<html lang="it">
  <head>
    ...
    <!-- TITOLO DELLA PAGINA -->
    <title> Tabella News - Comitato Sicurezza Stradale </title>
      ...
      <div class="sidebar-sticky">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a class="nav-link dropdown-toggle" href="#" id="altroMenuLink7" role="button" data-toggle="collapse" data-target="#altroMenu7" aria-expanded="false" aria-controls="altroMenu7">
              Gestione News
            </a>
            <div class="collapse" id="altroMenu7">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a class="nav-link" href="tabellanews.php">Tabella News</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="aggiunginews.php">Aggiungi News</a>
                </li>
              </ul>
            </div>
          </li>
...
<div class="alert alert-info" role="alert">
  <center><b> Benvenuto nella sezione dedicata alla gestione delle News </b><p>
    <br>
  Qui puoi inserire e gestire le ultime notizie e aggiornamenti riguardanti il Comitato Sicurezza Stradale. Resta aggiornato e condividi informazioni importanti con la nostra comunità. Inizia subito a pubblicare le tue News!"
</div>

<form method="GET" action="" class="mb-3">
    <div class="input-group mb-3">
        <a href="aggiunginews.php" class="btn btn-outline-primary rounded mr-2">Aggiungi News</a>
...
if (isset($_GET['submit'])) {
    ...
    $sql = "SELECT * FROM news WHERE cognome LIKE '%$cognome%' AND nome LIKE '%$nome%'";
} else {
...
if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td class='cell100 column2 align-middle text-center'>" . $row["nomenews"] . "</td>";
