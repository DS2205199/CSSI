...
<div class="message">
  ...
  <center> <p> Mi dispiace, ma non sei autorizzato a visualizzare i trasferimenti. Se hai bisogno di assistenza o se per te e un errore, contatta amministratore del sistema.</p></center>
  <br>
...
<html lang="it">
  <head>
    ...
    <!-- TITOLO DELLA PAGINA -->
    <title> Guarda Trasferimento - Comitato Sicurezza Stradale </title>
...
$stmt = $conn->prepare($query);
    ...
    if ($result) {
	  ...
	  echo '<div class="alert alert-danger" role="alert">';
      echo "Siamo spiacenti, ma non è stato possibile trovare nessuna trasferimento corrispondente all'ID specificato. Si prega di verificare l'ID inserito e riprovare. Per ulteriori assistenza, siamo a disposizione.";
      echo '</div>';
  }
} else {
	  echo '<div class="alert alert-danger" role="alert">';
            ...
            <div class="card mb-4 dark-profile">
              <div class="card-body">
                <table class="table user-view-table m-0">
                  ...
                  <center>Trasferimento N. <b><?php echo " " . $row["ID"], "" . "<br>";;?></span></h4></center></b> <br>
                  <center>Trasferimento di: <b><?php echo " " . $row["nome"],  " "  . $row["cognome"] . "<br>";;?></span></h4></center></b>
<br>
					  <div class="row">
    <div class="col-md-2">
        <p><b>Stato Trasferimenti :</b> <span class="text-light"><?php echo ($row["attivo"] == "1") ? "Attivo" : (($row["attivo"] == "0") ? "Non Attivo" : $row["attivo"]); ?></span></p>
    <hr>
	</div>
	<div class="col-md-10">
	<p><b>Cognome:</b> <span class="text-light"><?php echo $row["cognome"]; ?></span> | 
	   <b>Nome:</b> <span class="text-light"><?php echo $row["nome"]; ?></span> | 
	   <b>Destinazione</b> <span class="text-light"><?php echo $row["destinazione"]; ?></span> | 
	   <b>Data Richiesta:</b> <span class="text-light"><?php echo $row["datarichiesta"]; ?></span> | 
