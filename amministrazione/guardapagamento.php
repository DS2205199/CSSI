...
<div class="message">
  ...
  <center> <p> Mi dispiace, ma non sei autorizzato a visualizzare i Pagamenti. Se hai bisogno di assistenza o se per te e un errore, contatta amministratore del sistema.</p></center>
  <br>
...
<html lang="it">
  <head>
    ...
    <!-- TITOLO DELLA PAGINA -->
    <title> Guarda Pagamento - Comitato Sicurezza Stradale </title>
...
<!-- HTML FINE MENU NEWS -->
  ...
  <!------------------------------------------------------------------------>
  <!-- PRENDE ID E VISUALIZZA SU FORM -->
...
$stmt = $conn->prepare($query);
    ...
    $row = $result->fetch_assoc();
	  ...
	  echo '<div class="alert alert-danger" role="alert">';
      echo "Siamo spiacenti, ma non è stato possibile trovare nessun pagamento corrispondente all'ID specificato. Si prega di verificare l'ID inserito e riprovare. Per ulteriori assistenza, siamo a disposizione.";
      echo '</div>';
  }
} else {
	  echo '<div class="alert alert-danger" role="alert">';
...
?>
  ...
  <!-- FINE SELEZIONA ID E VISUALIZZA SU FORM -->
  <!------------------------------------------------------------------------>
  <!-- VISUALIZZA SUL FORM -->
            ...
            <div class="card mb-4 dark-profile">
              <div class="card-body">
                <table class="table user-view-table m-0">
                  ...
                  <center>Pagamento N. <b><?php echo " " . $row["ID"], "" . "<br>";;?></span></h4></center></b> <br>
                  <center>Pagamento di:<b><?php echo " " . $row["nome"],  " "  . $row["cognome"] . "<br>";;?></span></h4></center></b>
                      <br>
					  
<div class="row">
    <div class="col-md-2">
        <p><b>Numero:</b> <span class="text-light"><?php echo $row["numero"]; ?></span></p>
		<br>
		<p><b>Anno:</b> <span class="text-light"><?php echo $row["anno"]; ?></span></p>
		<br>
		<b>Importo:</b> <span class="text-light"><?php echo $row["importo"]; ?></span></p>
    <hr>
	</div>
    <div class="col-md-10">
	   <p><b>Cognome:</b> <span class="text-light"><?php echo $row["cognome"]; ?></span> | 
	   <b>Nome:</b> <span class="text-light"><?php echo $row["nome"]; ?></span> | 
	   <b>Registrato da:</b> <span class="text-light"><?php echo $row["registratoda"]; ?></span> | 
	   <b>Descrizione:</b> <span class="text-light"><?php echo $row["descrizione"]; ?></span> | 
	   <b>Email:</b> <span class="text-light"><?php echo $row["email"]; ?></span> |
	   <b>Data e Ora di Pagamento:</b> <span class="text-light"><?php echo $row["dataeoradipagamento"]; ?></span></p>
	   <br>
	   <br>
	   <br>
	   <br>
