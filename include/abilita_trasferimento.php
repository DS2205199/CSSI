...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT attivo FROM trasferimenti WHERE ID = '$id'";
    ...
    if ($result->num_rows > 0) {
        ...
        $query = "UPDATE trasferimenti SET attivo = '$nuovoStato' WHERE ID = '$id'";
        $conn->query($query);
    }
}

// Reindirizza alla pagina della tabella degli utenti
header("Location: /amministrazione/tabellatrasferimenti.php");
exit;
?>
