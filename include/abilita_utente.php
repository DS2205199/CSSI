...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT attivo FROM volontari WHERE ID = '$id'";
    ...
    if ($result->num_rows > 0) {
        ...
        $query = "UPDATE volontari SET attivo = '$nuovoStato' WHERE ID = '$id'";
        $conn->query($query);
    }
}

// Reindirizza alla pagina della tabella degli utenti
header("Location: /amministrazione/tabellavolontari.php");
exit;
?>
